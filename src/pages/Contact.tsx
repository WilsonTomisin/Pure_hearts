  ...
  return (
    <main>
      <div className="relative">
        ...
        <h1 className=" z-20 header-font text-6xl text-white font-semibold absolute top-1/2 left-1/2 -translate-x-1/2 ">
          Contact Us
        </h1>
      ...
      <section className=" max-w-[700px] mx-auto  bg-gray-100 p-7 rounded-xl my-10">
        ...
        <form className=" py-7 flex flex-col gap-y-5">
          ...
          <div>
            <button className=" p-5 rounded-ee-2xl bg-brand-colour-primary text-white">
              {' '}
              Send
            </button>
          </div>
      ...
      <section className=" my-10 px-10 grid grid-cols-3  justify-between">
        <div>
